...
public:
  ...
  static void SendPixelsInRenderThread(TSensor &Sensor, bool use16BitFormat = false,  bool useFlowFormat = false);
...
template <typename TSensor>
void FPixelReader::SendPixelsInRenderThread(TSensor &Sensor, bool use16BitFormat, bool useFlowFormat)
{
  ...
  (
    [&Sensor, Stream=Sensor.GetDataStream(Sensor), use16BitFormat, useFlowFormat](auto &InRHICmdList) mutable
    {
      ...
      if (!Sensor.IsPendingKill())
      {
        ...
        WritePixelsToBuffer(
            *Sensor.CaptureRenderTarget,
            ...
            InRHICmdList, use16BitFormat, useFlowFormat);
